...
<footer class="sticky-footer bg-secondary text-light border-top mt-5 py-3">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; <?php echo date('Y'); ?> North Shoa ICT</span> <div>Designed and Developed by <a href="https://ymesh21.github.io/" class="text-warning" target="_blank">Yohannes Meshesha</a> </div>
        </div>
    </div>
</footer>
<!-- End of Footer -->
